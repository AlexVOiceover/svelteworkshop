...
<div id="bag" class="max-w-5xl content-center rounded bg-gray-100 p-4 shadow">
	...
	<ul>
		{#each displayItems as item}
			...
			<div
				class="max-w-3xl content-center rounded-lg border border-gray-200 bg-white p-4 shadow-sm md:p-6 dark:border-gray-700 dark:bg-gray-800"
			>
				<div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
					<a href="/product/{item.handle}" class="shrink-0 md:order-1">
						<img class="h-20 w-20 dark:hidden" src={item.images[0]} alt={item.name} />
						<img class="hidden h-20 w-20 dark:block" src={item.images[1]} alt={item.name} />
					</a>
					...
					<div class="flex items-center justify-between md:order-3 md:justify-end">
						<div class="flex items-center">
							<button
								...
								class="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-gray-300 bg-gray-100 hover:bg-gray-200 focus:ring-2 focus:ring-gray-100 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700"
							>
								<svg
...
<!-- <section class="bg-white py-8 antialiased md:py-16 dark:bg-gray-900">
	<div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
		<h2 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Shopping Cart</h2>
		...
		<div class="mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
						...
						<div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
							...
							<div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
								<a
									href="#"
									class="text-base font-medium text-gray-900 hover:underline dark:text-white"
									>PC system All in One APPLE iMac (2023) mqrq3ro/a, Apple M3, 24" Retina 4.5K, 8GB,
						...
						<div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
							...
							<div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
								<a
									href="#"
									class="text-base font-medium text-gray-900 hover:underline dark:text-white"
									>Restored Apple Watch Series 8 (GPS) 41mm Midnight Aluminum Case with Midnight
									Sport Band</a
								>
						...
						<div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
							...
							<div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
								<a
									href="#"
									class="text-base font-medium text-gray-900 hover:underline dark:text-white"
									>Apple - MacBook Pro 16" Laptop, M3 Pro chip, 36GB Memory, 18-core GPU, 512GB SSD,
									Space Black</a
								>
					...
					<div class="mt-6 grid grid-cols-3 gap-4 sm:mt-8">
						...
						>
							...
							<div>
								...
								<p class="text-lg leading-tight font-bold text-red-600 dark:text-red-500">$299</p>
							</div>
							<div class="mt-6 flex items-center gap-2.5">
								<button
									data-tooltip-target="favourites-tooltip-1"
									type="button"
									class="hover:text-primary-700 inline-flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white p-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-100 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
								>
									<svg
										class="h-5 w-5"
										aria-hidden="true"
								...
								<button
									type="button"
									class="bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 inline-flex w-full items-center justify-center rounded-lg px-5 py-2.5 text-sm font-medium text-white focus:ring-4 focus:outline-none"
								>
									<svg
						...
						>
							...
							<div>
								...
								<p class="text-lg leading-tight font-bold text-red-600 dark:text-red-500">$499</p>
							</div>
							<div class="mt-6 flex items-center gap-2.5">
								<button
						...
						>
							...
							<div>
								...
								<p class="text-lg leading-tight font-bold text-red-600 dark:text-red-500">$1199</p>
							</div>
							<div class="mt-6 flex items-center gap-2.5">
								<button
			...
			<div class="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
				...
				>
					...
					<a
						href="#"
						class="bg-primary-700 hover:bg-primary-800 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 flex w-full items-center justify-center rounded-lg px-5 py-2.5 text-sm font-medium text-white focus:ring-4 focus:outline-none"
